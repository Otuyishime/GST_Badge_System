	...
	public class BadgeDAO //: IcrudOperations<Badge>
	{
		...
		public int uploadBadges()
		{
			using (var conn = new SqlConnection(connectionString))
			{
				...
				// Student to peer
				string path = @"C:\Users\Yuvette\Source\Repos\GST_Badge_System\GST_Badge_System.DAO\Data\Student-Peer.csv";
				pushBadgeHelper(conn, "Student to peer", path);

				// Student to self
				path = @"C:\Users\Yuvette\Source\Repos\GST_Badge_System\GST_Badge_System.DAO\Data\Student-Self.csv";
				pushBadgeHelper(conn, "Student to self", path);

				// Faculty to student
				path = @"C:\Users\Yuvette\Source\Repos\GST_Badge_System\GST_Badge_System.DAO\Data\Faculty-Student.csv";
				pushBadgeHelper(conn, "Faculty to student", path);

				// Staff to student
				path = @"C:\Users\Yuvette\Source\Repos\GST_Badge_System\GST_Badge_System.DAO\Data\Staff-Student.csv";
